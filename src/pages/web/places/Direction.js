...
function WebPlaceDirection() {
    ...
    const [longitude, setLongitude] = useState(110.41462451998511);
    const [latitude, setLatitude] = useState(-7.782148043878062);
                        ...
                        <div className="col-md-12 mb-5">
                            <div className="card border-0 rounded shadow-sm">
                              <div className="card-body">
                                ...
                                <h5><i className="fa fa-location-arrow"></i> Petunjuk arah dari lokasi anda ke lokasi wisata</h5>
                                <hr />
                                <p class="bg-info text-black">
                                Keterangan : <br/>    
                                Marker A : Lokasi anda saat ini <br/>
                                Marker B : Lokasi wisata yang anda tuju <br/>
                                <br/>
                                Marker A dapat anda geser sesuai lokasi anda saat ini.</p>
